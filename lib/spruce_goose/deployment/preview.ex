defmodule SpruceGoose.Deployment.Preview do
  @moduledoc """
  ...
  Reclamation execution is not part of this contract. A future governed adapter
  must recheck eligibility using authoritative, current cohort observations.
