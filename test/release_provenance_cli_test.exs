# This test replaces production modules to prove the read-only CLI path. Run it
# in its own BEAM VM so those replacements cannot contaminate the normal suite.
if System.get_env("SPRUCE_GOOSE_ISOLATED_PROVENANCE_CLI_TEST") == "1" do
  ExUnit.start()
