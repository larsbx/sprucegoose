defmodule SpruceGoose.Deployment.RetentionTest do
  use ExUnit.Case, async: true

  alias SpruceGoose.Deployment.Retention, as: Preview
  ...
  test "only the preview environment may ever be reclaimed" do
    for env <- [:staging, :production, "preview", nil, ""] do
  ...
  test "module deletes nothing and exposes no destructive operation" do
    source = File.read!("lib/spruce_goose/deployment/retention.ex")
